...
export class ProyectosEditar extends Component {
  render() {
    return (
      <View>
        <Text>ProyectosEditar</Text>
      </View>
    )
  }
}
...
// const ProyectosEditar = ({ navigation }: NativeStackScreenProps<MainStackParamList>) => {
...
//     axios.delete('http://192.168.1.70:3000/locations/' + route.params.locationId)
...
//     axios.patch('http://192.168.1.70:3000/locations/' + route.params.locationId, {
